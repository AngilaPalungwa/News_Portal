            ...
            <div class="card-body">
                ...
                <form action="{{ route('ads.update',$ad->id) }}" , method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select id="ads_category" class="form-control" name="ads_category" value="{{ $ad->ads_category }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" name="image" id="image" class="form-control" placeholder="Select Image" value="{{ $ad->image }}">
