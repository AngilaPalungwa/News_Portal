                    ...
                    <form action="{{ route('company.update',$company->id) }}" , method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="contact" id="contact" class="form-control"
                                placeholder="Enter your contact" value="{{ $company->contact}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="facebook" id="facebook" class="form-control"
                                placeholder="Enter your facebook" value="{{ $company->facebook }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="linkedin" id="linkedin" class="form-control"
                                placeholder="Enter your linkedin" value="{{ $company->linkedin }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="youtube" id="youtube" class="form-control"
                                placeholder="Enter your youtube" value="{{ $company->youtube }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="twitter" id="twitter" class="form-control"
                                placeholder="Enter your twitter" value="{{ $company->twitter}}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="aboutus" id="editor" cols="30" rows="10">{{ $company->aboutus}}</textarea>
